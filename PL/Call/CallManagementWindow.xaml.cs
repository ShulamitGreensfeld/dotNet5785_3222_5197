...
namespace PL
{
    public partial class CallManagementWindow : Window, INotifyPropertyChanged
    {
        ...
        public CallManagementWindow(int currentUserId, BO.Enums.CallStatus? initialStatus = null)
        {
            ...
            _refreshCallQuantities = CallQuantitiesObserver;
            s_bl.Call.AddObserver(_refreshCallQuantities);

            _refreshVolunteers = CallListObserver;
        ...
        public BO.Enums.CallType SelectedCallType
        {
            ...
            set { _selectedCallType = value; OnPropertyChanged(nameof(SelectedCallType)); CallListObserver(); }
        }
        ...
        public BO.Enums.CallStatus? SelectedCallStatus
        {
            ...
            set { _selectedCallStatus = value; OnPropertyChanged(nameof(SelectedCallStatus)); CallListObserver(); }
        }
        ...
        public string SelectedSortField
        {
            ...
            set { _selectedSortField = value; OnPropertyChanged(nameof(SelectedSortField)); CallListObserver(); }
        }
        ...
        public string SelectedGroupField
        {
            ...
            set { _selectedGroupField = value; OnPropertyChanged(nameof(SelectedGroupField)); CallListObserver(); }
        }
        ...
        private void CallListObserver()
        {
            ...
            {
                _observerCallListOp = Dispatcher.BeginInvoke((Action)(() => UpdateCallList()));
            }
        }
        ...
        private void CallQuantitiesObserver()
        {
            ...
            {
                _observerQuantitiesOp = Dispatcher.BeginInvoke((Action)(() => RefreshCallQuantities()));
            }
        }
        ...
        private void UpdateCallList()
        {
            ...
            foreach (var call in CallList)
            {
                ...
                Action observer = CallListObserver;
