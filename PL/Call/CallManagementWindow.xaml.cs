...
//{
//    public class CallManagementWindow : INotifyPropertyChanged
//    {
//        private static readonly IBl s_bl = Factory.Get();
...
//        public CallManagementWindow()
//        {
//            DeleteCommand = new RelayCommand<CallInList>(DeleteCall);
//            CancelAssignmentCommand = new RelayCommand<CallInList>(CancelAssignment);
...
//            var list = s_bl.Call.GetCallsList(filterField, filterValue, sortField).ToList();
